        ...
        <Wrapper>
            <Container>
                ...
                <Card>
                    ...
                    <CardBody>
                        {type == 'signup' &&
                            <TextInput value={nameInput} placeholder="Digite seu nome" onChange={e => setNameInput(e.target.value)} borderRadius="sm" />
                        }
                        <TextInput value={emailInput} placeholder="Digite seu e-mail" onChange={e => setEmailInput(e.target.value)} borderRadius="sm" />
